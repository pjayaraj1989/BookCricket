...
from functions.utilities import FillAttributes, PrintInColor, Randomize, Error_Exit, GetShortName, BallsToOvers, \
    PrintListFormatted, GetFirstName, GetSurname, CheckForConsecutiveElements, ChooseFromOptions
...
class Match:
            ...
            # batting second
                ...
                if batting_team.total_balls >= (self.overs * 6):
                    ...
                    if batting_team.total_score >= batting_team.target:
                        ...
                        PrintInColor(
                            Randomize(commentary.commentary_lost_chasing) % (batting_team.name, bowling_team.name),
                            Style.BRIGHT)
                    input('press enter to continue...')
                    break
    ...
    def Ball(self, run):
        ...
        while run == -1:
            ...
            if 'lbw' in dismissal:
                PrintInColor(Randomize(commentary.commentary_lbw_umpire) % self.umpire, Fore.LIGHTRED_EX)
