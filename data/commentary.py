...
class commentary():
    ...
    commentary_high_req_rate = ['reqd rate is really high for %s!',
                                ...
                                'thats a big task ahead for %s, and will be facing some quality pace attack too!']
    # comment situation based on Reqd RR
    commentary_situation_reqd_rate_low = ['%s well on course here!',
                                          'the reqd rate looks easily gettable for %s!',
                                          ...
                                          '%s are punishing the bowlers here! reqd rate is less than required',
    ...
    commentary_situation_reqd_rate_high = ['required rate is high!.. well %s, they need to gear up!',
                                           ...
                                           'bowlers are not giving % room to cope up with the reqd. rate!',
    ...
    commentary_runout = ['what a terrible mix up between %s and %s!',
                            'this is bizzare!.. terrible miscommunication between %s and %s',
                            ...
                            'there was absolutely no run there! poor running between the wkts between %s and %s!',
                            ...
                            'there was no run there! this is bizzare!. was it %s s call? i think it was %s',
    ...
    commentary_caught = ['in the air.. and taken by %s!',
                            'thats straight up in the air.. %s calls for it, taken!',
                            'bad shot.. leading edge and gone.. good take by %s!',
                            'outside edge and a magnificent catch! you beauty %s',
                            'thats not timed well and oh what a catch by %s!',
                            'in the air thats taken by %s! what a blinder!',
                            'brilliant catch! %s is a supreme athelete!',
                            'oh man! what a catch by %s! one of the best catches ever!',
                            'thats in the air, %s is underneath it, has he dropped it, no he hasnt! what a catch!',
                            'thats hit straight down the %s''s throat!',
    ...
    commentary_return_catch = ['beautiful return catch by %s!',
                               ...
                               'oh he has dropped.. no he hasnt! what a catch by %s!',
                               'thats out, caught n bowled by %s!',
                               'caught and bowled by %s! what a reflex!',
                               'what kind of reflexes by %s! Thats taken!',
    ...
    commentary_lbw_umpire = ['big appeal.. and %s ''s finger goes up!',
                             ...
                             'thats a big appeal.. and finally given lbw by %s!!',
    ...
    commentary_lbw_drs_taken = ['%s looks confused.. long chat with his partner %s.. and finally takes it upstairs!',
                                ...
                                'well, %s hasnt even discussed with %s, has gone upstairs instantly!',
                                'well %s has gone for the review instantly.. didnt even look at %s!']
    commentary_lbw_drs_not_taken = ['he is having a long chat with the non striker.. and finally he is walking off..',
                                    ...
                                    'are they going for the DRS here? I dont think so they are interested..']
    commentary_lbw_decision_stays = ['Well it shows that the ball will be hitting the top of off!. Decision stays.. good on field call %s!',
                                     'Pitching in line, impact in line.. hitting middle.. %s gets it dead right!!',
                                     'missing leg? No! thats out.. %s gets it right again!',
    ...
    commentary_dot_ball = ['beautiful delivery from %s, missed %s \'s stumps by inches!',
                            'good from %s, thats very well defended by %s!',
                            'well bowled %s and thats a solid defence from %s',
                            'accurate from %s and thats a textbook defence from %s!',
                            ...
                            'edged and dropped at first slip! dissapointment for %s.. oh dear!.. %s is lucky !',
                            ...
                            'thats in the air but put down by the keeper! oh what a miss for %s.. lucky %s!!',
                            'magnificent from %s, decieved %s and nearly missed the offstump',
                            ...
                            'what a ball %s, thats hit straight up in the air by %s, keeper says mine.. oh and put down!',
                            'bad ball from %s but thats hit in the air by %s, but falls in no mans land',
    ...
    commentary_out_first_ball = ['Out first ball.. %s has to go!!',
                                    ...
                                    'Thats a slow walk back when youre out first ball, %s!',
    ...
    commentary_wide = ['he has lost his line completely.. wide called by %s!',
                            ...
                            'bowler under pressure here!.. %s signales wide again!',]
    ...
    commentary_milestone = ['Its been a terrific knock by %s today..!',
                                ...
                                'Thats it! A brilliant knock under pressure by %s!',
    ...
    commentary_goingtolose = ['surely its all over now for %s!',
                              ...
                              'thats the end of all hopes for %s now!',
    ...
    commentary_lost_chasing = ['end of the match.. end of the chase tough luck %s, well played %s!!',
                               'afraid to say thats the end of the chase for %s! magnificent performance %s',
    ...
    commentary_expensive_over=['what an expensive over by %s!',
                               ...
                               'thats an expensive over from %s!',]
    ...
    commentary_maiden_over = ['what a bowler %s is.. thats a maiden over!',
                              'maiden over from %s!!!.. brilliant!',
                              'thats it.. its a maiden over for %s.. brilliant!']
